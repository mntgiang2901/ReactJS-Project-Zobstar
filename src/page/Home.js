                                ...
                                <div className="hero-content-wrapper position-relative">
                                    <div className="hero-heading text-center">
                                        ...
                                        <div className="btn-box margin-top-35px">
                                            <a href="job-grid-view.html" className="theme-btn me-2">Find a Job</a>
                                    ...
                                    <div className="hero-form-wrap position-absolute">
                                        <div className="main-search-input">
                                                ...
                                                <div className="contact-form-action">
                                                    <form action="#">
                                                        <div className="form-group mb-0">
                                                            <span className="la la-search form-icon" />
                                            ...
                                            <div className="main-search-input-btn">
                                                <Link to="#" className="button theme-btn line-height-50">Search Jobs</Link>
                                            </div>
...
================================= */}
    ...
    START TAG AREA
================================= */}
                <div className="tag-area padding-top-130px padding-bottom-90px text-center">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-heading">
                                    <h2 className="sec__title mb-0">Popular Searches</h2>
                                </div>
                                {/* end section-heading */}
                            </div>
                            {/* end col-lg-12 */}
                        ...
                        <div className="row mt-4">
                            <div className="col-lg-6 mx-auto">
                                <ul className="list-items job-tags d-flex flex-wrap justify-content-center">
                                    <li><a href="job-grid-view.html">Designer</a></li>
                                    <li><a href="job-grid-view.html">Developer</a></li>
                                    <li><a href="job-grid-view.html">Construction</a></li>
                                    <li><a href="job-grid-view.html">Web</a></li>
                                    <li><a href="job-grid-view.html">PHP</a></li>
                                    <li><a href="job-grid-view.html">Banking</a></li>
                                    <li><a href="job-grid-view.html">IOS</a></li>
                                    <li><a href="job-grid-view.html">Engineering</a></li>
                                    <li><a href="job-grid-view.html">Medical</a></li>
                                    <li><a href="job-grid-view.html">Freelance</a></li>
                                    <li><a href="job-grid-view.html">Accountancy</a></li>
                                    <li><a href="job-grid-view.html">Military</a></li>
                                    <li><a href="job-grid-view.html">Writing</a></li>
                                    <li><a href="job-grid-view.html">House Sitting</a></li>
                                    <li><a href="job-grid-view.html">Pharmacy</a></li>
                                    <li><a href="job-grid-view.html">Customer Service</a></li>
                                    <li><a href="job-grid-view.html">Nursing</a></li>
                                </ul>
                                <p className="font-weight-medium mt-3">
                                    320,940 new jobs in the last 7 days
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="cat-area padding-top-100px padding-bottom-110px text-center">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-heading">
                                    <h2 className="sec__title">Find Jobs by Categories</h2>
                        ...
                        <div className="row mt-5 justify-content-center">
                                ...
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            ...
                                            <span className="font-weight-medium">(3040)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Accounting / Finance</h4>
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Telecommunications</h4>
                                            <span className="font-weight-medium">(2340)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        <div className="icon-element mb-3">
                                            <i className="la la-hammer" />
                                        </div>
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Construction</h4>
                                            <span className="font-weight-medium">(1240)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Banking</h4>
                                            <span className="font-weight-medium">(1040)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Sales &amp; Marketing</h4>
                                            <span className="font-weight-medium">(7670)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">IT Contractor</h4>
                                            <span className="font-weight-medium">(2434)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Restaurants</h4>
                                            <span className="font-weight-medium">(3432)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Graduate</h4>
                                            <span className="font-weight-medium">(2240)</span>
                                        </div>
                                    </a>
                                </div>
                                {/* end category-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="category-item">
                                    <a href="job-grid-view.html" className="cat-fig-box d-block p-4">
                                        ...
                                        <div className="cat-content">
                                            <h4 className="cat__title mb-2">Public Sector</h4>
                                            <span className="font-weight-medium">(1240)</span>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div className="row mt-5">
                            <div className="col-lg-4 responsive-column">
                                <div className="icon-box">
                                    ...
                                    <div className="info-content mt-4">
                                        <h4 className="info__title mb-3">Find the Right Job</h4>
                            ...
                            <div className="col-lg-4 responsive-column">
                                <div className="icon-box">
                                    ...
                                    {/* end icon-element*/}
                                    <div className="info-content mt-4">
                                        <h4 className="info__title mb-3">Research Companies</h4>
                                        <p className="info__desc">
                                            Sed quia lipsum dolor sit atur adipiscing elit is nunc quis
                                            tellus sed ligula porta ultricies quis nec nec magna
                                        </p>
                            ...
                            <div className="col-lg-4 responsive-column">
                                <div className="icon-box">
                                    ...
                                    {/* end icon-element*/}
                                    <div className="info-content mt-4">
                                        <h4 className="info__title mb-3">Save &amp; Apply</h4>
                                        <p className="info__desc">
                                            Sed quia lipsum dolor sit atur adipiscing elit is nunc quis
                                            tellus sed ligula porta ultricies quis nec nec magna
                                        </p>
...
================================= */}
                                ...
                                <div className="tab-shared">
                                    <ul className="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                        <li className="nav-item">
                                            <a className="nav-link theme-btn active" id="recent-tab" data-bs-toggle="tab" href="#recent-job" role="tab" aria-controls="recent-job" aria-selected="true">
                                                Recent Jobs
                                            </a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link theme-btn" id="feature-tab" data-bs-toggle="tab" href="#feature-job" role="tab" aria-controls="feature-job" aria-selected="false">
                                                Feature Jobs
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="tab-content margin-top-35px" id="myTabContent">
                                    <div className="tab-pane fade show active" id="recent-job" role="tabpanel" aria-labelledby="recent-tab">
                                        <div className="row">
                                            <div className="col-lg-4 responsive-column">
                                                    ...
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
	...
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                                          ...
                                                          L311.404,311.377z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                ...
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="card-foot d-flex align-items-center justify-content-between mt-4">
                                                            <span className="color-text-2 font-size-13"><i className="la la-briefcase" /> Full Time</span>
                                                            <span className="color-text-2 font-size-13"><i className="la la-clock-o" /> 3 hours ago</span>
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style={{ enableBackground: 'new 0 0 512.007 512.007' }} xmlSpace="preserve">
                                                          ...
                                                          c-9.245-5.504-18.851-8.257-28.821-8.257C379.77,201.005,373.46,202.773,367.906,206.302z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">MuffinTech</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                        ...
                                                        <div className="card-content mt-4 margin-bottom-30px">
                                                            <h4 className="card-title mb-2">
                                                                <a href="job-details.html">Executive, HR Operations</a>
                                                            </h4>
                                                            <p className="card-sub">
                                                                Sed quia lipsum dolor sit atur adipiscing elit is
                                                                nunc quis tellus sed ligula
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style={{ enableBackground: 'new 0 0 512.007 512.007' }} xmlSpace="preserve">
                                                      ...
                                                      C383.137,307.978,381.634,320.855,365.11,320.852z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">GoodLayer</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                        ...
                                                        <div className="card-content mt-4 margin-bottom-30px">
                                                            <h4 className="card-title mb-2">
                                                                <a href="job-details.html">Art Production Specialist</a>
                                                            </h4>
                                                            <p className="card-sub">
                                                                Sed quia lipsum dolor sit atur adipiscing elit is
                                                                nunc quis tellus sed ligula
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_4" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                                      ...
                                                      l-97.297-97.297C394.909,194.75,373.92,191.013,358.365,200.896z" />
                                                          ...
                                                          c-4.668,3.699-8.337,10.386-11.009,20.056C340.326,281.411,341.211,325.575,341.211,380.461z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">ThemeGood</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_5" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#423966' }} cx={256} cy="255.997" r="255.997" />
                                                                        <path style={{ fill: '#2c2547' }} d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
                                                      v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
                                                      c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                                          ...
                                                          L311.404,311.377z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">TechyDevs</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                        ...
                                                        <div className="card-content mt-4 margin-bottom-30px">
                                                            <h4 className="card-title mb-2">
                                                                <a href="job-details.html">ACB Product Sales Specialist</a>
                                                            </h4>
                                                            <p className="card-sub">
                                                                Sed quia lipsum dolor sit atur adipiscing elit is
                                                                nunc quis tellus sed ligula
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_6" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.007 512.007" style={{ enableBackground: 'new 0 0 512.007 512.007' }} xmlSpace="preserve">
                                                          ...
                                                          c0.001,0.001,0,0,0.002,0.002c20.771,20.771,46.439,34.066,78.039,38.884C183.92,336.758,178.273,317.225,178.273,295.243z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">Penske Media</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                        ...
                                                        <div className="card-content mt-4 margin-bottom-30px">
                                                            <h4 className="card-title mb-2">
                                                                <a href="job-details.html">Senior Web Designer</a>
                                                            </h4>
                                                            <p className="card-sub">
                                                                Sed quia lipsum dolor sit atur adipiscing elit is
                                                                nunc quis tellus sed ligula
                                    ...
                                    {/* end tab-pane */}
                                    <div className="tab-pane fade" id="feature-job" role="tabpanel" aria-labelledby="feature-tab">
                                        <div className="row">
                                            <div className="col-lg-4 responsive-column">
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#263364' }} cx={256} cy={256} r={256} />
                                                                        <path style={{ fill: '#151f45' }} d="M358.365,200.896c-3.076,1.955-6.348,4.972-9.815,9.046l-10.753-10.753h-44.549v74.864
                                                      L151.473,132.279h-50.524v248.182l130.349,130.349C239.427,511.588,247.665,512,256,512c125.879,0,230.536-90.853,251.978-210.563
                                                      l-97.297-97.297C394.909,194.75,373.92,191.013,358.365,200.896z" />
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#423966' }} cx={256} cy="255.997" r="255.997" />
                                                                        <path style={{ fill: '#2c2547' }} d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
                                                      v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
                                                      c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                                          ...
                                                          L311.404,311.377z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">RevoTheme</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_9" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.007 512.007" style={{ enableBackground: 'new 0 0 512.007 512.007' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#2a2b46' }} cx="256.003" cy="256.003" r="256.003" />
                                                                        <path style={{ fill: '#1c1c2e' }} d="M378.109,185.822l-2.539,3.533l-54.687-54.687c-3.281-4.153-6.851-8.18-10.746-12.076
                                                          c-25.901-25.901-60.338-40.166-96.966-40.165c-36.633,0-71.074,14.266-96.978,40.17s-40.171,60.345-40.17,96.978
                                                          c0,35.021,13.046,68.034,36.827,93.504l-0.065,0.065l193.84,193.84c46.011-9.23,87.561-30.789,121.058-61.093l18.21-18.21
                                                          ...
                                                          c0.001,0.001,0,0,0.002,0.002c20.771,20.771,46.439,34.066,78.039,38.884C183.92,336.758,178.273,317.225,178.273,295.243z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">Unbold</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_10" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#423966' }} cx={256} cy="255.997" r="255.997" />
                                                                        <path style={{ fill: '#2c2547' }} d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
	v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                                          ...
                                                          L311.404,311.377z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">ThemePress</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_11" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style={{ enableBackground: 'new 0 0 512.007 512.007' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#59480c' }} cx="256.003" cy="256.003" r="256.003" />
                                                                        <path style={{ fill: '#382d08' }} d="M367.906,206.302c-2.807,1.784-5.794,4.539-8.959,8.257l-9.814-9.814h-40.662v3.953l-48.827-48.827
                                                          l-0.009,0.009c-2.399-2.373-4.972-4.509-7.732-6.391c-7.011-4.776-14.956-7.919-23.837-9.425c-8.88-1.504-22.356-2.26-40.427-2.26
                                                          H96.345v228.391l141.133,141.133c6.118,0.438,12.293,0.672,18.523,0.672c125.835,0,230.461-90.791,251.954-210.438l-92.299-92.299
                                                          c-9.245-5.504-18.851-8.257-28.821-8.257C379.77,201.005,373.46,202.773,367.906,206.302z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">PixelSort</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                                                ...
                                                <div className="job-card">
                                                    <div className="job-card-content">
                                                        <div className="card-head d-flex align-items-center">
                                                            <div className="company-avatar me-3">
                                                                <a href="employer-details.html" className="d-block">
                                                                    <svg className="card-svg" version="1.1" id="Capa_12" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style={{ enableBackground: 'new 0 0 512.007 512.007' }} xmlSpace="preserve">
                                                                        <circle style={{ fill: '#4f0a0a' }} cx="256.003" cy="256.003" r="256.003" />
                                                                        <path style={{ fill: '#260505' }} d="M245.901,114.471c0,0-25.629-4.553-25.966,30.35c-0.337,34.903,17.199,68.625,17.199,68.625
                                                      c-14.163,47.886-44.851,104.54-44.851,104.54c-63.735,26.64-72.504,42.828-76.887,47.886c-2.87,3.312-7.861,18.265,0.098,26.453
                                                      l-0.003,0.003L234.233,511.07c7.177,0.604,14.433,0.931,21.767,0.931c106.526,0,197.844-65.071,236.403-157.628L258.441,120.409
                                                      ...
                                                      C383.137,307.978,381.634,320.855,365.11,320.852z" />
                                                            ...
                                                            <div className="company-title-box">
                                                                <h4 className="card-title mb-1">
                                                                    <a href="employer-details.html">DesingLayer</a>
                                                                </h4>
                                                                <p className="card-sub">
                                                                    <i className="la la-map-marker" /> Aberdeen, United
                                                                    Kingdom
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="btn-box text-center mt-4">
                                    <a href="job-grid-view.html" className="theme-btn">View all Jobs</a>
                                </div>
                            </div>
                            {/* end col-lg-12 */}
                        </div>
...
================================= */}
    ...
    START FUN-FACT AREA
================================= */}
                <section className="funfact-area section-bg-2 padding-top-100px padding-bottom-60px text-center">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-heading">
                                    ...
                                    <p className="sec__desc color-white-rgba">
                                        Nam libero tempore, cum soluta nobis est eligendi optio cumque
                                        nihil impedit <br />
                                        facere possimus, omnis voluptas assumenda est, omnis
                                    </p>
                        ...
                        <div className="row mt-5">
                            <div className="col-lg-3 responsive-column">
                                <div className="counter-item">
                                    ...
                                    <div className="counter-number">
                                        <span data-purecounter-duration="2.5" data-purecounter-end={19000} className="counter purecounter">0</span>
                                    </div>
                                    {/* end counter-number */}
                                    <div className="counter-content mt-3">
                                        <p className="counter__title">Jobs Posted</p>
                                    </div>
                                    {/* end counter-content */}
                                </div>
                                {/* end counter-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="counter-item">
                                    ...
                                    <div className="counter-number">
                                        <span data-purecounter-duration="2.5" data-purecounter-end={8090} className="counter purecounter">0</span>
                                    </div>
                                    {/* end counter-number */}
                                    <div className="counter-content mt-3">
                                        <p className="counter__title">Candidates</p>
                                    </div>
                                    {/* end counter-content */}
                                </div>
                                {/* end counter-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="counter-item">
                                    <div className="icon-element">
                                        <i className="la la-black-tie" />
                                    </div>
                                    <div className="counter-number">
                                        <span data-purecounter-duration="2.5" data-purecounter-end={15095} className="counter purecounter">0</span>
                                    </div>
                                    {/* end counter-number */}
                                    <div className="counter-content mt-3">
                                        <p className="counter__title">Companies</p>
                                    </div>
                                    {/* end counter-content */}
                                </div>
                                {/* end counter-item */}
                            ...
                            <div className="col-lg-3 responsive-column">
                                <div className="counter-item">
                                    ...
                                    <div className="counter-number">
                                        <span data-purecounter-duration="2.5" data-purecounter-end={2350} className="counter purecounter">0</span>
                                    </div>
                                    {/* end counter-number */}
                                    <div className="counter-content mt-3">
                                        <p className="counter__title">Resumes</p>
                                    </div>
                                    {/* end counter-content */}
                                </div>
                                {/* end counter-item */}
...
================================= */}
                <section className="testimonial-area padding-top-100px padding-bottom-100px text-center">
                    <div className="container">
                        ...
                        <div className="row mt-5">
                            <div className="col-lg-12">
                                <div className="testimonial-carousel carousel-item-wrap">
                                    <div className="testimonial-item">
                                        <div className="testi-content mb-3">
                                            <img src="images/small-team1.jpg" className="testi__img" alt="" />
                                            <h4 className="tesi__title mt-4">Richard Doe</h4>
                                            <span className="testi__meta">Web Designer</span>
                                        </div>
                                    ...
                                    <div className="testimonial-item">
                                        <div className="testi-content mb-3">
                                            <img src="images/small-team2.jpg" className="testi__img" alt="" />
                                            <h4 className="tesi__title mt-4">Denwen Evil</h4>
                                            <span className="testi__meta">UI/UX Designer</span>
                                        </div>
                                        <div className="testi-comment">
                                            <p className="testi__desc">
                                                Excepteur sint occaecat cupidatat non proident sunt in culpa
                                    ...
                                    <div className="testimonial-item">
                                        <div className="testi-content mb-3">
                                            <img src="images/small-team3.jpg" className="testi__img" alt="" />
                                            <h4 className="tesi__title mt-4">Collis Pong</h4>
                                            <span className="testi__meta">Engineer</span>
                                        </div>
                                        <div className="testi-comment">
                                            <p className="testi__desc">
                                                Excepteur sint occaecat cupidatat non proident sunt in culpa
...
================================= */}
                <section className="clientlogo-area padding-top-95px padding-bottom-90px text-center">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-heading">
                                    <h2 className="sec__title mb-0">
                                        Top Companies Hiring at Zobstar Now
                                    </h2>
                                </div>
                                {/* end section-heading */}
                            </div>
                        ...
                        <div className="row margin-top-35px">
                            <div className="col-lg-9 mx-auto">
                                <div className="client-logo-wrap d-flex flex-wrap justify-content-center align-items-center">
                                    <div className="client-logo-item">
                                        <img src="images/client-logo.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-2.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-3.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-4.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-5.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-6.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-7.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-8.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-9.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-10.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-11.png" className="img-fluid" alt="brand-image" />
                                    </div>
                                    {/* end client-logo-item */}
                                    <div className="client-logo-item">
                                        <img src="images/client-logo-3.png" className="img-fluid" alt="brand-image" />
...
================================= */}
    ...
    START CTA AREA
================================= */}
                <section className="cta-area section-bg responsive-text-center padding-top-80px padding-bottom-80px">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-9">
                                <div className="section-heading">
                                    <h2 className="sec__title mb-2 font-size-26 line-height-35">
                                        Zobstar is the Best Way to Find &amp; Discover <br />
                                        Great Local Jobs
                                    </h2>
                                    <p className="sec__desc">
                            ...
                            <div className="col-lg-3">
                                <div className="btn-box">
                                    <a href="contact.html" className="theme-btn">Join with us</a>
                                </div>
                                {/* end btn-box */}
                            </div>
                            {/* end col-lg-3 */}
...
================================= */}
                <section className="mobile-app-area padding-top-100px padding-bottom-110px">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-6 ms-auto">
                                <div className="mobile-app-content">
                                    <div className="section-heading margin-bottom-30px">
                                        <h2 className="sec__title">
                                    ...
                                    <ul className="info-list contact-links">
                                        <li className="d-flex align-items-center mb-4">
                                            <span className="flex-shrink-0 la la-search-plus" />
                                            <div className="app-title-box">
                                                <h4 className="widget-title pb-2 font-weight-bold">
                                                    AR Job Search
                                                </h4>
                                        ...
                                        <li className="d-flex align-items-center mb-4">
                                            <span className="flex-shrink-0 la la-map-marker" />
                                            <div className="app-title-box">
                                                <h4 className="widget-title pb-2 font-weight-bold">
                                                    Search on the go
                                                </h4>
                                        ...
                                        <li className="d-flex align-items-center mb-4">
                                            <span className="flex-shrink-0 la la-bell-o" />
                                            <div className="app-title-box">
                                                <h4 className="widget-title pb-2 font-weight-bold">
                                    ...
                                    <div className="btn-box d-flex text-start margin-top-40px">
                                        <Link to="#" className="theme-btn download-btn"><i className="la la-apple" />App Store</Link>
                                        <Link to="#" className="theme-btn download-btn"><i className="la la-android" />Google Play</Link>
                                    </div>
                                    {/* end btn-box */}
                                </div>
                            </div>
...
================================= */}
 ...
 START BLOG AREA
================================= */}
                <section className="blog-area padding-top-100px padding-bottom-100px">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-heading text-center">
                                    <h2 className="sec__title">
                                        See How You Can up Your Career <br />
                                        Status Tips &amp; Articles
                                    </h2>
                                    <p className="sec__desc">
                        ...
                        <div className="row mt-5">
                                ...
                                <div className="card-item">
                                    <div className="card-content-wrap">
                                        <div className="card-badge-wrap">
                                            <span className="card-badge">Jobs</span>
                                            <div className="icon-element">
                                                ...
                                                <ul className="shared-list">
                                                    ...
                                                    <li>
                                                        <Link to="#"><i className="la la-twitter" /></Link>
                                                    </li>
                                                    <li>
                                                        <Link to="#"><i className="la la-instagram" /></Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-content">
                                            ...
                                            <p className="card-meta">
                                                <img src="images/small-team1.jpg" alt="" className="author-avatar" />
                                                <span className="font-weight-semi-bold">Kamran Adi</span> - 25
                                                Jan, 2020
                                            </p>
                                        </div>
                                        {/* end card-content */}
                            ...
                            <div className="col-lg-4 responsive-column">
                                <div className="card-item">
                                    <div className="card-content-wrap">
                                        <div className="card-badge-wrap">
                                            <span className="card-badge">Retail</span>
                                            <div className="icon-element">
                                                <i className="la la-share-alt" />
                                                <ul className="shared-list">
                                                    <li>
                                        ...
                                        <div className="card-content">
                                            ...
                                            <p className="card-meta">
                                                <img src="images/small-team2.jpg" alt="" className="author-avatar" />
                                                <span className="font-weight-semi-bold">David Wise</span> - 25
                                                Jan, 2020
                                            </p>
                                        </div>
                                        {/* end card-content */}
                            ...
                            <div className="col-lg-4 responsive-column">
                                <div className="card-item">
                                    <div className="card-content-wrap">
                                        <div className="card-badge-wrap">
                                            <span className="card-badge">Health</span>
                                            <div className="icon-element">
                                                <i className="la la-share-alt" />
                                                <ul className="shared-list">
                                                    <li>
                                        ...
                                        <div className="card-content">
                                            ...
                                            <p className="card-meta">
                                                <img src="images/small-team3.jpg" alt="" className="author-avatar" />
                                                <span className="font-weight-semi-bold">Mike Doe</span> - 25
                                                Jan, 2020
                                            </p>
                                        </div>
                                        {/* end card-content */}
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="btn-box text-center mt-4">
                                    <a href="blog-grid.html" className="theme-btn">Read More Articles</a>
                                </div>
                            </div>
                            {/* end col-lg-12 */}
                        </div>
...
================================= */}
    ...
    START CTA AREA
================================= */}
                <section className="cta-area cta-area-2 responsive-text-center section-bg-2 padding-top-70px padding-bottom-70px">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-9">
                                <div className="section-heading">
                                    <h2 className="sec__title mb-2 text-white font-size-26 line-height-40">
                            ...
                            <div className="col-lg-3">
                                <div className="btn-box">
                                    <a href="employer-dashboard-post-job.html" className="theme-btn">Post a Job</a>
                                </div>
                                {/* end btn-box */}
                            </div>
                            {/* end col-lg-3 */}
